...
export const game = button.addEventListener('click', () => {
    ...
    const player1Grid = document.querySelector('.player-board').querySelectorAll(".grid");
    const player2Grid = document.querySelector('.computer-board').querySelectorAll(".grid");
